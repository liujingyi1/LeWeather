...
import com.letrans.weather.leweather.view.CityClickListener;
import com.letrans.weather.leweather.view.MySectionIndexer;
import com.letrans.weather.leweather.view.PinnedHeaderListView;
import com.letrans.weather.leweather.view.PinterestAdapter;
import com.letrans.weather.leweather.view.PresetCityListAdapter;
import com.letrans.weather.leweather.view.SideBar;
import com.letrans.weather.leweather.work.CityInfo;
import com.letrans.weather.leweather.work.PresetCityInfo;
...
public class AddCityActivity extends AddCityEntryActivity {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (WeatherAction.ACTION_ADD_WEATHER_FINISH.equals(action)) {
				...
				AddCityActivity.this.setResult(
						CityManager.REQUEST_CODE_CITY_ADD, null);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mCityInfos = WeatherApplication.mModel.getCityInfos();
	...
	protected void onStop() {
		super.onStop();
		WeatherApplication.mModel.stopQueryCity();
	}
	...
	private void searchCity() {
		...
		if (name.isEmpty()) {
			...
			WeatherApplication.mModel.setOnCityInfoUpdatedListener(onCityInfoUpdatedListener);
			if (!WeatherApplication.mModel.getCityInfosByNameFromInternet(name)) {
				showLoadingProgress(false);
			}
		}
	}
	...
	private void addCity(CityInfo info) {
		...
		if(!WeatherApplication.mModel.addWeatherByCity(info, false)) {
			showLoadingProgress(false);
		}
	}
